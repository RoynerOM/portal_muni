...
class FiltroActas extends StatefulWidget {
  const FiltroActas({super.key});

  @override
  State<FiltroActas> createState() => _FiltroActasState();
}

class _FiltroActasState extends State<FiltroActas> {
            ...
            children: [
              ...
              Container(
                ...
                child: InputSelect(
                  ...
                  options: [
                    Option(index: 0, value: 'Acta'),
                    Option(index: 1, value: 'Orden del dia'),
                  ],
