...
class RegistroInformePersonalPage extends StatefulWidget {
  const RegistroInformePersonalPage({super.key, required this.tipo});
  final String tipo;
  @override
  State<RegistroInformePersonalPage> createState() =>
      _RegistroInformePersonalPageState();
}

class _RegistroInformePersonalPageState
    extends State<RegistroInformePersonalPage> {
...
class UploadButton extends StatelessWidget {
  const UploadButton({
    ...
    required InformePersonalModel model,
  })  : _documento = documento,
        _model = model;

  final File? _documento;
  final InformePersonalModel _model;
